# @farfarawaylabs/react-native-beauitful-controls
...
This library is also using a few other required libraries. Run the following command:

```sh
npm install react-native-elements react-native-vector-icons @react-native-community/blur
...
To finish the installation of react-native-vector-icons follow the instructions on their site.
Note: You mostly only need to edit your info.plist file and build.gradle file as stated.
...
<img width="300" height="600" src="https://github.com/nechmads/demo_images/blob/master/fflabs_react_native_beautiful_controls/Overlay.gif?raw=true">
...
<img width="300" height="600" src="https://github.com/nechmads/demo_images/blob/master/fflabs_react_native_beautiful_controls/Carousel.gif?raw=true">
...
<img width="300" height="600" src="https://github.com/nechmads/demo_images/blob/master/fflabs_react_native_beautiful_controls/AnimatedListItem.gif?raw=true">
